...
import type { InvoiceOttobockFilterFormValues } from "@rupoi/entities/invoice-ottobock"
import { invoicePriorityOptions, invoiceStatusOptions } from '@rupoi/shared/constant'

interface Props {
  data?: InvoiceOttobockFilterFormValues
  disabled?: boolean
}
...
const emit = defineEmits<{
  search: [value: InvoiceOttobockFilterFormValues]
  reset: [value: InvoiceOttobockFilterFormValues]
}>()

const formData = ref<InvoiceOttobockFilterFormValues>({
  q: props.data?.q ?? null,
