...
import type { InvoiceProsthesisFilterFormValues } from "@rupoi/entities/invoice-prosthesis"
import { invoicePriorityOptions, invoiceStatusOptions } from '@rupoi/shared/constant'

interface Props {
  data?: InvoiceProsthesisFilterFormValues
  disabled?: boolean
}
...
const emit = defineEmits<{
  search: [value: InvoiceProsthesisFilterFormValues]
  reset: [value: InvoiceProsthesisFilterFormValues]
}>()

const formData = ref<InvoiceProsthesisFilterFormValues>({
  q: props.data?.q ?? null,
