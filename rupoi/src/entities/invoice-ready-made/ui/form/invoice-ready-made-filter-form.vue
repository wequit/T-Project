...
import type { InvoiceReadyMadeFilterFormValues } from "@rupoi/entities/invoice-ready-made"
import { invoicePriorityOptions, invoiceStatusOptions } from '@rupoi/shared/constant'

interface Props {
  data?: InvoiceReadyMadeFilterFormValues
  disabled?: boolean
}
...
const emit = defineEmits<{
  search: [value: InvoiceReadyMadeFilterFormValues]
  reset: [value: InvoiceReadyMadeFilterFormValues]
}>()

const formData = ref<InvoiceReadyMadeFilterFormValues>({
  q: props.data?.q ?? null,
