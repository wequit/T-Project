...
import type { InvoiceRepairFilterFormValues } from "@rupoi/entities/invoice-repair"
import { invoicePriorityOptions, invoiceStatusOptions } from '@rupoi/shared/constant'

interface Props {
  data?: InvoiceRepairFilterFormValues
  disabled?: boolean
}
...
const emit = defineEmits<{
  search: [value: InvoiceRepairFilterFormValues]
  reset: [value: InvoiceRepairFilterFormValues]
}>()

const formData = ref<InvoiceRepairFilterFormValues>({
  q: props.data?.q ?? null,
