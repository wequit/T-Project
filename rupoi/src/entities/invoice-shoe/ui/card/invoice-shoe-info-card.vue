  ...
  <div class="card mb-3">
    <div class="card-body">
      ...
      <div class="row g-3">
        ...
        <div class="col-12 col-md-6">
          <BaseInfoField label="Модель" icon="fas fa-shoe-prints">
            {{ props.data.order?.modelRef?.nameRu || '—' }}
          </BaseInfoField>
        </div>

        <div class="col-12 col-md-6">
          <BaseInfoField label="Цвет" icon="fas fa-palette">
            {{ props.data.order?.shoeColorRef?.nameRu || '—' }}
          </BaseInfoField>
        </div>
