...
import type { OrderOttobockFilterFormValues } from '@rupoi/entities/order-ottobock'
import { orderStatusOptions, orderPriorityOptions } from '@rupoi/shared/constant'

interface Props {
  data?: OrderOttobockFilterFormValues
  disabled?: boolean
}
...
const emit = defineEmits<{
  search: [value: OrderOttobockFilterFormValues]
  reset: [value: OrderOttobockFilterFormValues]
}>()

// Локальное состояние формы
const formData = ref<OrderOttobockFilterFormValues>({
