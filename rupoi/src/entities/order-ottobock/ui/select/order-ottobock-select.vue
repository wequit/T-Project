...
import { useOrderOttobockList } from '../../model/queries'
import type { ID } from '@rupoi/shared/model'
import type { OrderOttobockListParams } from '../../model/types'
...
const orderListParams = ref<OrderOttobockListParams>({
  query: undefined,
...
const orderListQuery = useOrderOttobockList(orderListParams)
