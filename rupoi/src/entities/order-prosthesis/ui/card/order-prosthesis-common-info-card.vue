  ...
  <div class="card mb-3">
    <div class="card-body">
      ...
      <div class="row g-3">
        ...
        <div class="col-12 col-md-6">
          <BaseInfoField label="Сторона протеза" icon="fas fa-arrows-alt-h">
            <BaseStatusTag :status="props.data.prosthesisSide" />
          </BaseInfoField>
        </div>
        ...
        <div class="col-12 col-md-6">
          <BaseInfoField label="Вес (кг)" icon="fas fa-weight">
            {{ props.data.weightKg || '—' }}
          </BaseInfoField>
        </div>

        <div class="col-12 col-md-6">
          <BaseInfoField label="Рост (см)" icon="fas fa-ruler-vertical">
            {{ props.data.height || '—' }}
          </BaseInfoField>
        </div>

        <div class="col-12 col-md-6">
          <BaseInfoField label="Степень активности" icon="fas fa-running">
            <BaseStatusTag :status="props.data.activityLevel" />
          </BaseInfoField>
        </div>
