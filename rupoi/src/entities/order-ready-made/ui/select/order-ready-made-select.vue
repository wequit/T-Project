...
import { useOrderReadyMadeList } from '../../model/queries'
import type { ID } from '@rupoi/shared/model'
import type { OrderReadyMadeListParams } from '../../model/types'
...
// Query params for order ready-made list
const orderListParams = ref<OrderReadyMadeListParams>({
  query: undefined,
...
const orderListQuery = useOrderReadyMadeList(orderListParams)
