...
import { useOrderRepairList } from '../../model/queries'
import type { ID } from '@rupoi/shared/model'
import type { OrderRepairListParams } from '../../model/types'
...
// Query params for order repair list
const orderListParams = ref<OrderRepairListParams>({
  query: undefined,
...
const orderListQuery = useOrderRepairList(orderListParams)
