...
import { useOrderRepair, type OrderRepairDTO } from '@rupoi/entities/order-repair'
...
const { addFileMutation, removeFileMutation } = useOrderRepair({
  id: () => props.orderRepair?.id ?? null
})
