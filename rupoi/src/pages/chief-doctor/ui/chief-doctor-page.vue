...
import { ChiefDoctorOrderList } from '@rupoi/widgets/chief-doctor-order-list'
...
const chiefDoctorListRef = ref<InstanceType<typeof ChiefDoctorOrderList> | null>(null)
    ...
    <div class="card">
      <div class="card-body">
        <BaseTabs
          ...
          variant="pills"
        >
          <ChiefDoctorOrderList
            ref="chiefDoctorListRef"
            :key="activeTab"
