...
import { DispatcherOrderList } from '@rupoi/widgets/dispatcher-order-list'
...
const dispatcherListRef = ref<InstanceType<typeof DispatcherOrderList> | null>(null)
