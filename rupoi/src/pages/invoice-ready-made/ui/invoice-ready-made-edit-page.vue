...
const invoiceReadyMadeId = computed(() => Number(route.params.id) as ID)
...
function handleSuccess() {
  router.push({ name: RouteConfig.Invoice.readyMade.view.name, params: { id: invoiceReadyMadeId.value } })
}
</script>
        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="d-flex align-items-center justify-content-between">
              <h5 class="mb-0">Редактирование накладной — Готовые ПОИ</h5>
              <AButton
                type="button"
                color="secondary"
                size="sm"
          ...
          <div class="card-body">
            <InvoiceReadyMadeSave 
              :invoice-ready-made-id="invoiceReadyMadeId" 
