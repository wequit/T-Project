...
const chiefDoctorStatuses = [OrderStatus.UNDER_REVIEW, OrderStatus.APPROVED]
const pageSize = 20
const currentPage = ref(0)

const ordersQuery = useQuery({
  queryKey: ['chief-doctor-orders', props.orderType, currentPage],
  queryFn: () => props.service.getList({
    status: chiefDoctorStatuses,
