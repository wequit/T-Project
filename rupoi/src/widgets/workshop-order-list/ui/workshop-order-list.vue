...
const workshopStatuses = [OrderStatus.IN_PRODUCTION, OrderStatus.FOR_FITTING, OrderStatus.READY]
const pageSize = 20
const currentPage = ref(0)

const ordersQuery = useQuery({
  queryKey: ['workshop-orders', props.orderType, currentPage],
  queryFn: () => props.service.getList({
    status: workshopStatuses,
