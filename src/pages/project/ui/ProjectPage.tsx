...
import { ProjectHeader, BoardTabs, ColumnCard, AddColumnSection } from "@/widgets/project-board";
import { useBoardUI } from "@/shared/lib/hooks/useBoardUI";
import { useColumnUI } from "@/shared/lib/hooks/useColumnUI";
...
export const ProjectPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <ProjectHeader projectName={project.name} onBack={handleBack} />
