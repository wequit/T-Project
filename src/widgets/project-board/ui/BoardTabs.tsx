...
import type { BoardUI, BoardAction } from "@/shared/types";
...
export const BoardTabs: FC<BoardTabsProps> = ({
  boards,
  selectedBoardId,
  setSelectedBoardId,
  boardUI,
          ...
          >
            {boardUI.renamingBoardId === board.id ? (
              <input
                ...
                onChange={(e) =>
                  boardDispatch({ type: "SET_RENAME_VALUE", payload: e.target.value })
                }
                onBlur={() => {
                ...
                <div className="relative">
                  <button
                    onClick={() =>
                      boardDispatch({
                        type: "TOGGLE_MENU",
                        payload: boardUI.openBoardMenuId === board.id ? null : board.id,
                      })
                    }
